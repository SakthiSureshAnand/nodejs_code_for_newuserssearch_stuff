...
var app = angular.module('EmailProjectScreens', ['ngRoute','ui.grid','ui.grid.selection']);
   ...
   $httpProvider.defaults.withCredentials = true;
       $routeProvider
            ...
            .when('/Screen_500-en', {
                         templateUrl : 'app/views/en/Screen_500-en.html',
          controller: 'SearchListScreen_Default_Activity'
                         ,allow:'ROLE_USER'
                     })
...
$rootScope.isLogIn = false;
				$rootScope.logout = function(){
					...
					$rootScope.userData = {};
					console.log("*****-----logout---null--->>->>>data>>>"+angular.toJson($rootScope.userData));
					$location.url('/login')
				}
